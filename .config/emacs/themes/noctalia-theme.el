...
(let* ((bg "#131313")
      ...
      (tertiary "#cbc1e9")
      (tertiary-container "#494263")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#cbc1e9")
      (on-success "#332c4c")
      (success-container "#494263")
      (on-success-container "#e7deff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#80d0ff")
      (primary-fixed-dim "#004c6a")
      (secondary-fixed "#b6c9d8")
      (secondary-fixed-dim "#374955")
      (tertiary-fixed "#cbc1e9")
      (tertiary-fixed-dim "#494263")
      (on-primary-fixed "#00344b")
      (on-primary-fixed-variant "#c5e7ff")
      (on-secondary-fixed "#20333e")
      (on-secondary-fixed-variant "#d2e5f4")
      (on-tertiary-fixed "#332c4c")
      (on-tertiary-fixed-variant "#e7deff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e2e2")
