...
(let* ((bg "#1b1206")
      ...
      (on-surface "#f3dfcb")
      (on-surface-variant "#dec2a2")
      (on-tertiary "#462a00")
      (on-tertiary-container "#ffddb7")
      (outline-color "#a68c6f")
      (outline-variant "#57432b")
      (primary "#ffb3af")
      (primary-container "#7e2a2a")
      (secondary "#ffb3af")
      (secondary-container "#733331")
      (shadow "#000000")
      (surface "#1b1206")
      (surface-container "#281e11")
      (surface-container-high "#33281b")
      (surface-container-highest "#3f3325")
      (surface-container-low "#241a0d")
      (surface-container-lowest "#150c03")
      (surface-variant "#57432b")
      (tertiary "#f7bc70")
      (tertiary-container "#643f00")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f7bc70")
      (on-success "#462a00")
      (success-container "#643f00")
      (on-success-container "#ffddb7")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb3af")
      (primary-fixed-dim "#7e2a2a")
      (secondary-fixed "#ffb3af")
      (secondary-fixed-dim "#733331")
      (tertiary-fixed "#f7bc70")
      (tertiary-fixed-dim "#643f00")
      (on-primary-fixed "#5f1416")
      (on-primary-fixed-variant "#ffdad7")
      (on-secondary-fixed "#571d1c")
      (on-secondary-fixed-variant "#ffdad7")
      (on-tertiary-fixed "#462a00")
      (on-tertiary-fixed-variant "#ffddb7")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3dfcb")
      (inverse-primary "#ffb3af")
      (inverse-surface "#1b1206")
